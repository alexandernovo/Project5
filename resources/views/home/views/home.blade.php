...
@section('content')
    <div class="d-flex justify-content-center align-items-center gap-4 " style="height: calc(100vh - 122px);">
        <div class="text-center ">
            ...
            <p class="mb-1" style="font-size: 17px; font-style: italic;">Ensuring Business Legality, Supporting Environment Goals</p>
        </div>
        <div class="ms-3">
