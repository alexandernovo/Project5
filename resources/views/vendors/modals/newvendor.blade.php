<div class="modal fade" id="newvendorModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="newvendorModalLabel"
    aria-hidden="true">
            ...
            <form id="newvendorform">
                ...
                <div class="modal-body">
                    <div class="row mx-auto">
                        ...
                        <div class="col-6">
                            <div class="form-group mb-1">
                                <label for="" class="mb-1">Name of Vendor <span class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-1">
                                <label for="" class="mb-1">Type of Vendor <span class="text-danger">*</span></label>
