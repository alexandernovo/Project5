                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Vendors Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="container bg-white p-5 border rounded shadow-sm mt-2"
                    ...
                    @php
                        $badges = [
                            ...
                            ['label' => 'Type of Vendor', 'value' => ':TYPEOFVENDOR',],
                            ['label' => 'Day', 'value' => ':day'],
                        ...
                        <div class="d-flex gap-1 flex-wrap">
                            @foreach ($badges as $badge)
                                @php
                                    $type = $badge['type'] ?? '';
                                @endphp
                                <span {{ $type ? "data-type=' $type'" : '' }}
                                    class="badge badge-choice bg-secondary-new text-white"
                                    data-badge="{{ $badge['value'] }}" style="cursor:pointer;">
                                    {{ $badge['label'] }}
                                </span>
                            @endforeach
                        </div>
                        ...
                        {{ $certificate && $certificate->description
                            ...
                            : " <p><strong>TO WHOM IT MAY CONCERN:</strong></p>
                                <p style='text-indent: 40px'>
                                    ...
                                    <strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:OWNER_NAME</strong> is a
                                    <span class='highlight-bg-cert text-uppercase' contenteditable='false'>:TYPEOFVENDOR</span> resident of
                                    <span class='highlight-bg-cert' contenteditable='false'>:address</span>
                                ...
                                <p style='text-indent: 40px'>
                                    This certification is issued to <strong> $sex <span
                                        class='text-uppercase'><strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:OWNER_NAME</strong></span></strong> or whatever legal purpose it may serve.
                                </p>
                                <p style='text-indent: 40px'>
                    ...
                    <a href="{{ route('vendor_view') }}" type="button" class="btn-close position-absolute"
...
@endsection
@section('js')
    @include('vendors.js.editcertification')
@endsection
