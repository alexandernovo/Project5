                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Tricycle Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <textarea id="description" name="description" required>
                        {{ $certificate && $certificate->description
                            ...
                            : "<p><strong>TO WHOM IT MAY CONCERN:</strong></p>
                                ...
                                <p style='text-indent: 40px'>
                                    This certification is issued to $sex <strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:OWNER_NAME</strong> or whatever legal purpose it may serve.
                                </p>
                                <p style='text-indent: 40px'>
...
@endsection
@section('js')
    @include('tricycle.js.editcertification')
@endsection
