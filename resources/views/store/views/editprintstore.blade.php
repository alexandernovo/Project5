                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Sari-Sari Store Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="container bg-white p-5 border rounded shadow-sm mt-2"
                        ...
                        {{ $certificate && $certificate->description
                            ...
                            : "<p><strong>TO WHOM IT MAY CONCERN:</strong></p>
                                <p style='text-indent: 40px'>
                                    ...
                                    <strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:OWNER_NAME</strong> owner of
                                    <strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:STORE_NAME</strong> located at <span class='highlight-bg-cert' contenteditable='false'>:address</span>
                                ...
                                <p style='text-indent: 40px'>
                                    This certification is issued to $sex <span class='text-uppercase'><strong class='highlight-bg-cert text-uppercase' contenteditable='false'>:OWNER_NAME</strong></span> or whatever legal purpose it may serve.
                                </p>
                                <p style='text-indent: 40px'>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <textarea id="signatory" name="signatory" required>
                            {{ $certificate && $certificate->signatory
                    ...
                    <textarea id="ornodescription" name="ornodescription" required>
                        {{ $certificate && $certificate->ornodescription
                            ? $certificate->ornodescription
                    ...
                    <a href="{{ route('store_view') }}" type="button" class="btn-close position-absolute"
...
@endsection
@section('js')
    @include('store.js.editcertification')
@endsection
