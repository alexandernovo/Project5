            ...
            <div class="container bg-white p-5 border rounded shadow-sm mt-2 paper_printable"
                ...
                <div style="font-size:16px; text-align:justify; line-height:1.8;">
                    {!! $description != "" ? "<p style='white-space: pre-wrap'>{$description}</p>" : "
                        ...
                        <p style='text-indent: 40px'>
                            This certification is issued to $sex <span class='text-uppercase'>$record->owner_name</span> or whatever legal purpose it may serve.
                        </p>
                ...
                <a href="{{ route('store_view') }}" type="button" class="btn-close position-absolute" style="top:15px; right:15px;"
                    aria-label="Close"></a>
            </div>
        </div>
    </div>
