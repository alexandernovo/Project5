<script>
    $(document).ready(function() {
        ...
        $('.badge-choice').on('click', function() {
            ...
            let tags = (badgeText.toLowerCase().includes("owner") || badgeText.toLowerCase().includes("store")) ? "strong" : 'span';
            var type = (badgeText.toLowerCase().includes("owner") || badgeText.toLowerCase().includes("store")) ? "text-uppercase" : '';
