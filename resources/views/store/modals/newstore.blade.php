<div class="modal fade" id="newstoreModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="newstoreModalLabel"
    aria-hidden="true">
            ...
            <form id="newstoreform">
                ...
                <div class="modal-body">
                    <div class="row mx-auto">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-1">
                                <label for="" class="mb-1">Name of Store</label>
                                <input type="text" name="name_other" placeholder="Name of Store"
