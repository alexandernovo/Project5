<script>
                ...
                render: function(data, type, row) {
                    return `
                        <div class="d-flex gap-2 text-center align-items-center">
                            ...
                            <a href="{{ route('printAssociation') }}?record_id=${row.record_id}" onclick="event.stopPropagation();"  class="btn btn-secondary-new-2 px-2"><i class="bi bi-printer"></i></a>
    ...
    $(document).on("click", ".expRenButton", function(e) {
        ...
        if (data) {
            ...
            message = 'Renew this Association?';
            buttonConfirm = 'Renew';
