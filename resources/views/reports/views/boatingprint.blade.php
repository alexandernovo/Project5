            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="fw-semibold mb-0 text-nowrap">Report | Boating</h4>
                    </div>
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Report | Boating</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
@section('js')
    ...
    @include('reports.js.boatingdownload')
@endsection
