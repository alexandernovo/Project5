                ...
                <div class="d-flex justify-content-between align-items-end">
                    <form method="GET" class=" w-25 mb-0">
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" name="month_waste"
                                value="{{ request('month_waste', date('Y-m')) }}" onchange="this.form.submit()">
                        </div>
                    </form>
                ...
                <div id="printable">
                    ...
                    @if ($categoryWaste == 'Overall')
                        <p class="mb-2 mt-4 text-center fw-semibold text-uppercase" style="font-size: 20px; color: black">
                            WASTE COLLECTION REPORT AS OF
                            {{ date('F Y', strtotime(request('monthyear', date('Y-m')) . '-01')) }}
                        </p>
                    @else
                        <p class="mb-2 mt-4 text-center fw-semibold text-uppercase" style="font-size: 20px; color: black">
                            WASTE COLLECTION REPORT OF BARANGAY {{ $barangayWaste }} AS OF
                            {{ date('F Y', strtotime(request('monthyear', date('Y-m')) . '-01')) }}
                        </p>
                    @endif
...
@section('js')
    ...
    @include('reports.js.collectiondownload')
@endsection
