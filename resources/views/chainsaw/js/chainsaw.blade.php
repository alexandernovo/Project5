                ...
                render: function(data, type, row) {
                    return `
                        <div class="d-flex gap-2 text-center align-items-center">
                            ...
                            <a href="{{ route('printChainsaw') }}?record_id=${row.record_id}" onclick="event.stopPropagation();"  class="btn btn-secondary-new-2 px-2"><i class="bi bi-printer"></i></a>
